...
| CO4 | Node.js backend orchestration and Spring Boot service presence | [backend/src/app.js](../backend/src/app.js), [springboot/README.md](../springboot/README.md), [docs/spring-verification-report.md](spring-verification-report.md) |
